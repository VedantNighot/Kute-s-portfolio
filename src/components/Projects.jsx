    ...
    >
      <div className="WRAPPER mt-10" data-aos="fade-down">
        ...
        >
          ...
          <Project_prop
            title="Chat Corner"
            para="Chat App that helps in real time chaatting ."
            img={Rocket}
            link=" "
            github_link=" "
            html5={
          ...
          <Project_prop
            title="Jarvis"
            para="Jarvis is an AI-powered voice assistant that listens, thinks, and talks back—just like your personal tech sidekick!"
            img={WellBeing}
            link=" "
            github_link=" "
            html5={
