...
var processStyleName3 = memoize3(function(styleName) {
...
var isPrependedWithRegularRules3 = function isPrependedWithRegularRules4(index, children2) {
  for (var i = index - 1; i >= 0; i--) {
...
var incorrectImportAlarm3 = function incorrectImportAlarm4(element, index, children2) {
...
var prefixer3 = function prefixer4(element, index, children2, callback) {
  if (element.length > -1) {
    if (!element["return"]) switch (element.type) {
      case DECLARATION:
...
function deepClone(source) {
  if (React10.isValidElement(source) || (0, import_react_is.isValidElementType)(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React10.isValidElement(source[key]) || (0, import_react_is.isValidElementType)(source[key])) {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GXVLAFCB.js.map
